...
namespace client.localhost {
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void registerAsync(string fname, string lname, string reg, string password) {
            this.registerAsync(fname, lname, reg, password, null);
        }
        
        /// <remarks/>
        public void registerAsync(string fname, string lname, string reg, string password, object userState) {
